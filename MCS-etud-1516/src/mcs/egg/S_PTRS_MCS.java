...
if  (att_eval)      action_type1_15(x_4);
    x_4.analyser() ;
...
private void action_type1_15(S_PTRS_MCS x_4) throws Exception {
try {
// locales
POINTEUR loc_p;
// instructions
x_4.att_htype= new POINTEUR(this.att_htype);
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MCS", "#type1","PTRS -> mult #type1 PTRS1 #type ;"});
}
  }
...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MCS", "#type","PTRS -> mult #type1 PTRS1 #type ;"});
}
  }
