...
att_scanner._interrompre(IProblem.Semantic, att_scanner.getBeginLine(), IMCSMessages.id_B_07, MCSMessages.B_07,new Object[]{""+x_2.att_txt});
...
try {
// instructions
this.att_type= new DTYPE("void", 1);
